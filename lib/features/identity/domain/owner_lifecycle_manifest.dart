...
const ownerLifecycleManifest = <OwnerLifecycleTableDescriptor>[
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'personal_set_members',
    alias: 'personalSetMembers',
    authority: OwnerLifecycleAuthority.directOwner,
    // Complete ordered members are embedded in each exported revision.
    exportDisposition: OwnerLifecycleExportDisposition.aggregateOnly,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: ['recordCount'],
  ),
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'motivation_measurement_runs',
    alias: 'motivationMeasurementRuns',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'motivation_responses',
    alias: 'motivationResponses',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'research_participation_permits',
    alias: 'researchParticipationPermits',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'measurement_opportunities',
    alias: 'measurementOpportunities',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'research_session_proofs',
    alias: 'researchSessionProofs',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'session_configurations',
    alias: 'sessionConfigurations',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
  ...
  OwnerLifecycleTableDescriptor(
    tableName: 'learner_preferences',
    alias: 'learnerPreferences',
    authority: OwnerLifecycleAuthority.directOwner,
    exportDisposition: OwnerLifecycleExportDisposition.allowlistedPersonal,
    deletionDisposition: OwnerLifecycleDeletionDisposition.deleteDirect,
    allowedExportFields: [
