...
class _ShopPageState extends State<ShopPage> {
  ...
  Future<void> _loadData() async {
    ...
    await Future.wait([_fetchUserPoints(), _fetchProducts()]);
  ...
  Future<void> _buyProduct(Map<String, dynamic> product) async {
    ...
    if (userPoints < productPrice) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('แต้มของคุณไม่เพียงพอ!')));
      return;
    }
    ...
    try {
      ...
      await FirebaseFirestore.instance.runTransaction((transaction) async {
        ...
        transaction.update(stateRef, {
          'totalPoints': FieldValue.increment(-productPrice),
        });
        transaction.set(
                                    ...
                                    ElevatedButton.icon(
                                      ...
                                      style: ElevatedButton.styleFrom(
                                        backgroundColor: Colors
                                            .deepPurple, // ✅ เปลี่ยนสีปุ่มเป็นสีม่วงให้เข้ากับธีม
