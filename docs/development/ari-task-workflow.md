...
อัปเดต 2026-09-20: ผู้ใช้ให้หาวิธีและลงมือพัฒนาต่อ เปิด V1-R1 เป็นหนึ่ง project task เพื่อสร้าง diagnostic adapter และรัน protocol กับ binary จริงโดยไม่ใช้บัญชี/โมเดล ตาม [แผนทดลอง](ari/V1-R1.md). เป็นการตรวจทางเทคนิคใน V1; ไม่เปลี่ยน V2 gate หรือรับรองการใช้งาน Free ก่อนพิสูจน์
