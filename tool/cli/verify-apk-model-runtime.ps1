...
$expectedLibraries = [ordered]@{
    ...
    'lib/arm64-v8a/libtflite_custom_ops.so' =
        '89910411F5F5FD0908F1DB96942255208436AF4129FC8966CC3F401A469B436A'
    ...
    'lib/armeabi-v7a/libtflite_custom_ops.so' =
        '96CE2F1C0B380D94C2DB2F1E8F2C38DDF2A6D7798D72C7861AB1BAC79B5C9EF8'
    ...
    'lib/x86_64/libtflite_custom_ops.so' =
        'F6148A5A7C18055EC50DC721EC22912277722A2E64B63E33A54258C160F36924'
}
